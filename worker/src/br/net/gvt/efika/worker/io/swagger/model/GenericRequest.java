package br.net.gvt.efika.worker.io.swagger.model;

import br.net.gvt.efika.customer.EfikaCustomer;
import com.fasterxml.jackson.annotation.JsonProperty;
import java.util.Objects;
import java.util.Date;
import br.net.gvt.efika.worker.io.swagger.model.enums.ParamTypeEnum;
import br.net.gvt.efika.worker.io.swagger.model.enums.SystemEnum;
